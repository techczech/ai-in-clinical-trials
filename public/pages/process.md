...
This page documents the exact process undertaken to research and build this exhibit. It is a chronological record of the tools, prompts, and actions taken on **28 January 2026**.

## Deep Research / Search Queries

### Consensus
*   **Prompt**: "How useful is generative AI in the context of clinical trials?"
*   **Method**: Pro search using a free account.
*   **Result**: [Shared Consensus Results](https://consensus.app/search/generative-ai-clinical-trials/FG_gpejsRui5nJ7Lp0kLQw/)
*   **Output**: A synthesis of research papers highlighting high potential but early-stage evidence.

### Elicit
*   **Prompt**: "Survey of the use of Large Language Models in clinical trials."
*   **Method**: Research report workflow (Subscription).
*   **Result**: [Shared Elicit Report](https://elicit.com/review/5538287b-d2b2-45c7-b29b-84b9462fece2)
*   **Output**: Generated a report doc (available in sourcefiles) summarizing key findings from literature.

### ChatGPT Deep Research
*   **Prompt 1**: "research the Internet for relevant case studies for each section - do not make any assumptions about what might be relevant only describe what people reported - look at social media, blogs, news articles, publications, etc."
*   **Prompt 2 (Follow-up)**: "research the Internet for relevant case studies for each section - do not make any assumptions about what might be relevant only describe what people reported - look at social media, blogs, news articles, publications, etc."
*   **Method**: Pro subscription.
*   **Result**: [Shared ChatGPT Research](https://chatgpt.com/s/dr_697b1269229c8191a6a1daf93dbb85ea)
*   **Output**: Full text file with case studies (saved in sourcefiles).

### NotebookLM Deep Research
*   **Method**: Pro subscription, Deep Research feature.
*   **Result**: [Shared Notebook](https://notebooklm.google.com/notebook/5437f419-a79b-4088-b808-84ab44e48b01)
*   **Outputs**:
    *   CSV table of dates and findings (Prompt: "Create a table of dates of report and the finding with a column of positive and negative lessons learned.")
    *   Mindmap image (generated in Studio).
    *   Video overview (generated without custom prompt).
    *   Briefing document (generated without custom prompt).

## Other Source Materials

### ChatGPT Generated List of Scenarios
*   **Initial Prompt**: "I'm going to do training for this group tomorrow about the use of AI. Write as many scenarios as possible about the research and the roles, and what sort of tasks these people perform that I could use first without AI—just what they do, how they gather data, analyze, organize, and what tasks each of the people mentioned perform in various scenarios. Outline some realistic scenarios for all of these. Then, suggest how they could use ChatGPT, as well as other tools such as Notebook LM, Deep Research, and coding tools to support their work. Make sure it's relevant for the context of Oxford in 2026. Surgical Intervention Trials Unit, NDORMS The group is responsible for running clinical trials and comprises trial managers, principal investigators, research physiotherapists, data managers, trial assistants and DPhil students."
*   **Follow-up Prompt**: "not detailed enaough - dor each scenario write a 2-3 vignette of what actullya happens not terse but descriptive for osmeone like me"
*   **Model**: GPT-5.2 Thinking (Standard thinking time).
*   **Output**: A scenario file (saved in sourcefiles) which populated the searchable "Clinical Scenarios" on this website.

## Building This Website

### Setup
*   Used **Google Antigravity**.
*   Set up repository folder and opened in Antigravity.
*   Set up subfolders for `processnotes` and `sourcefiles` and downloaded/copied files.
*   Started taking process notes in Markdown.
*   Used **MacWhisper** to dictate the initial prompt to Antigravity.

### Antigravity Execution
*   **Model**: Gemini 3 Flash (Planning Mode).
*   **Initial Prompt**:
